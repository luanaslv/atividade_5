...
class RecrutadorApp:
    def __init__(self, master):
        ...
        # Elementos da interface, contendo: cidade, estado, expectativa salarial.
    ...
    def visualizar_candidatos(self):
        ...
        # Query de consulta com base nos campos preenchidos acima, retornando todos os candidatos caso nenhum filtro seja preenchido.
