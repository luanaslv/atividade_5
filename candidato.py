...
class CandidatoApp:
    def __init__(self, master):
        ...
        # Elementos da interface gráfica contendo: nome, idade, cidade, estado, telefone, e-mail, entre outros, do candidato)
    ...
    def salvar_dados(self):
        ...
        # Conecção com o banco de dados SQLite
        conn = sqlite3.connect('dados_devs.db')
        cursor = conn.cursor()

        # Criação da tabela desenvolvedores (caso exista, abre tal)
        ...
        # inserção de dados na tabela acima
        ...
        # Commita e fecha a conexão com o banco
        conn.commit()
        conn.close()

        # Limpeza de campos após submissão  
        self.limpar_campos()
